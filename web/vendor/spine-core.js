...
(function (spine) {
	var SkeletonBinary = (function () {
		...
		SkeletonBinary.prototype.readSkeletonData = function (binary) {
			...
			// 兼容 3.8.75 版本（原 runtime 拒绝此版本，但实际可以正常解析）
	...
	var BinaryInput = (function () {
		...
		BinaryInput.prototype.readByte = function () {
			// [PATCHED] use getUint8 (unsigned) to avoid signed-arithmetic-right-shift bug
			// that breaks multi-byte UTF-8 decoding (CJK chars). See spine-webgl.js sibling.
